// это новый вариант переиспользовал как на странице DashBoard (добавил пагинация, сортировка)
...
export default function DealsTable() {
    ...
    const { deals, loadDeals, loading } = useDeals();
        ...
        rows: deals
            ? Object.values(deals).map((element) => {
                ...
                return {
                    ...
                    OPPORTUNITY: `${element.OPPORTUNITY} руб.`,
                    action: (
                        <MDTypography
                            component="a"
                            href="#"
...
// =================================
//это старый вариант от Heattehnik
// import React, { useEffect, useState } from "react";
// import Cookies from "js-cookie";
// import useDeals from "./useDeals";
// import MDBox from "components/MDBox";
