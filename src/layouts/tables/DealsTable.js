...
export default function DealsTable() {
    ...
    const handleResetFilters = () => {
        ...
        // Сброс страницы к первой
        setPage(1);
        // Загрузка данных без фильтров
        loadDeals(1, {});
    };

    // проверка заполненности полей, что бы кнопка постоянно случайно не срабатывала
    const isFormValid = () => {
            ...
            {isLoading ? (
                ...
                <>
                    ...
                    >
                        ...
                        {/* Период с */}
                        <Box display="flex" alignItems="center" gap={0.5} sx={{ minWidth: 240 }}>
                            <MDTypography variant="button">С:</MDTypography>
                            <TextField
                                type="datetime-local"
                        ...
                        {/* Период по */}
                        <Box display="flex" alignItems="center" gap={0.5} sx={{ minWidth: 240 }}>
                            <MDTypography variant="button">По:</MDTypography>
                            <TextField
                                type="datetime-local"
